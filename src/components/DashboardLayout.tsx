...
export default function DashboardLayout({ userId, userName }: DashboardLayoutProps) {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-bold text-ink-primary tracking-tight">SocioLite</span>
            </div>

            {/* Right: Actions */}
            <div className="flex items-center gap-2">
              <span className="text-sm text-ink-secondary mr-2 hidden sm:block">
                {userName}
              </span>
