...
interface Props { isOpen: boolean; onClose: () => void; eventId: string; currentTitle: string; onSuccess: () => void }

export default function RenameEventModal({ isOpen, onClose, eventId, currentTitle, onSuccess }: Props) {
